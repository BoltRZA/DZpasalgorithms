...
public class ChartsForTrip {

    private static ChartsForTrip chartsForTrip;
    ...
    public static void createAnalogChart(String name, int number){
        if(chartsForTrip ==null) chartsForTrip = new ChartsForTrip();
